...
class Toast {
    ...
    func showAlert(type: AlertType, message: String) {
        ...
        attributes.entryBackground = .gradient(gradient: .init(colors: [EKColor(.init(red: 164/255, green: 179/255, blue: 244/255, alpha: 1)), EKColor(.init(red: 86/255, green: 117/255, blue: 255/255, alpha: 1))], startPoint: .zero, endPoint: CGPoint(x: 1, y: 1)))
