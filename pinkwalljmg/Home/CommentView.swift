            ...
            VStack(alignment: .leading){
                ...
                ScrollView( showsIndicators: false) {
                  ...
                  //  let totalWidth = count * screenWidth
                    ...
                    ScrollView( fetcher.blogs[blogId ?? 0].allMedia.count == 1 ? [] : .horizontal , showsIndicators: false) {
                        List {
                            HStack {
                                ...
                                ForEach(0 ..< count, id: \.self) { item in
                                    ...
                                    if fetcher.blogs[blogId ?? 0].allMedia[item]["type"] as! String == "1"{
                                        ...
                                        WebView(request:URLRequest(url: URL(string: fetcher.blogs[blogId ?? 0].allMedia[item]["media"] as! String )!))
                                            .onDisappear(){
                    ...
                    ForEach((fetcher.blogs[blogId ?? 0].blogComments ?? [] ) , id: \.id) { message in
